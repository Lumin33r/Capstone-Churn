...
# ── IAM Role with IRSA trust for the controller ServiceAccount ───────
resource "aws_iam_role" "alb_controller" {
  name = "${var.team_name}-alb-controller-role"
...
output "alb_controller_role_arn" {
  description = "IAM role ARN for ALB controller — used in Helm install"
